...
public class TestDecorator {
	...
	public static void main(String[] args) {
		...
		ACMECharacter dragon = new FantasyCharacter("Geany", 1000);
		dragon.move();
		dragon.takeAHit(700);
		dragon.heal(100);
		
		//Not like this brooooo
//		ACMECharacter dragonWithArmor = 
//				new ArmorDecorator(dragon, 200);
//		dragonWithArmor.takeAHit(300);
		...
		ACMECharacter dragon2 = new FantasyCharacter("Alberto", 1000);
		dragon2.move();
